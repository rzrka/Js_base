...
function insertPosts() {
    ...
    let i = 0 // НЕ ПОНЯЛ КАК ПРАВИЛЬНО СДЕЛАТЬ ЦИКЛ
    while (i >= 0) {
        scrollCheck.insertAdjacentHTML('afterbegin', getPostMarkup(Number(i)));
        i++;
    }
    let postsMarkup = '';
    scrollCheck.insertAdjacentHTML('afterbegin', getPostMarkup(Number(1)))
