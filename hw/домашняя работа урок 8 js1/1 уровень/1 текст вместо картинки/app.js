...
function handleClick(clickedButtonEvent) {
    ...
    if (card.button.innerText == "Подробнее") {1 // 4.1 проверяем равняется ли этот текст строке "Подробнее"
...
function hideMoreText(card) {
    ...
    card.wrap.classList.remove('.desc')
...
function showMoreText(card) {
    ...
    card.productName.insertAdjacentHTML('afterbegin', '<div class = "desc">qwerty</div>')
